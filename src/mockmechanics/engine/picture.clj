(ns mockmechanics.engine.picture
  (:require [mockmechanics.engine.util :refer :all]
            [mockmechanics.engine.xml :refer :all]
            [clojure.string :refer [split]])
  (:import (org.apache.batik.transcoder image.ImageTranscoder
                                        image.ImageTranscoder
                                        TranscoderInput
                                        TranscoderOutput
                                        TranscodingHints)
           (org.apache.batik anim.dom.SVGDOMImplementation
                             util.SVGConstants)
           (java.io FileInputStream ByteArrayInputStream File)
